<template>
	<div style="margin-bottom:70px;">
		...
		<div v-if="loginStep == 'register'">
		    <div style="margin-top:40px">
				<x-input name="register_phone" placeholder="请输入手机号" is-type="china-mobile" :value.sync="registerData.phone" class="login-input"></x-input>
				<x-input name="register_password" placeholder="请输入密码" type="password" :value.sync="registerData.pwd" class="login-input"></x-input>
	    ...
	    <!-- <div v-if="loginStep == 'forget'">
		    <div style="margin-top:40px">
				<x-input name="phone" placeholder="请输入手机号" is-type="china-mobile" :value.sync="forgetData.phone" class="login-input"></x-input>
				<x-input name="password" placeholder="请输入新密码" type="password" :value.sync="forgetData.pwd" class="login-input"></x-input>
				<div class="captcha_item">
			...
			<div style="margin-left:10px;margin-right:10px;margin-top:40px;">
				<button @click="modify" type="primary" class="login-btn">修改密码</button>
			</div>
		<div> -->
	</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			register: function () {
				if (this.registerData.phone == undefined || this.registerData.phone.length != 11) {
					alert('请输入正确的手机号');
					return;
				};
				if (this.registerData.pwd == undefined || this.registerData.pwd == '') {
					alert('请输入密码');
					return;
				};
