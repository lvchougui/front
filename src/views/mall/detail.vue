        ...
        <div class="content">
            <div class="product-info">
                ...
                <div class="info-detail" :style="height:imgStyle.height">
                    ...
                    <div style="margin-top:30px;">作品材质：{{detail.p_material}}</div>
                    <div style="margin-top:10px;">作品尺寸：{{detail.p_size}}</div>
                    <div style="margin-top:10px;">作品重量：{{detail.p_weight}}</div>
                    <div style="margin-top:30px;">{{detail.summary}}</div>
                    <div id="qrcode" style="width:100px;height:100px;position:absolute;right:0;bottom:0;"></div>
                </div>
            </div>
